...
##
## turtle.color(s): The color method sets the color that the pen will hold
## for all drawing until the color is changed. It takes a string argument which
## the desired color name.
##
...
# let's start up a Turtle Graphics window wi5th a red turtle (pen)
turtle.color("red")
